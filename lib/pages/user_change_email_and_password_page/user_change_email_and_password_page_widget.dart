...
import 'user_change_email_and_password_page_model.dart';
export 'user_change_email_and_password_page_model.dart';

class UserChangeEmailAndPasswordPageWidget extends StatefulWidget {
  const UserChangeEmailAndPasswordPageWidget({super.key});

  @override
  State<UserChangeEmailAndPasswordPageWidget> createState() =>
      _UserChangeEmailAndPasswordPageWidgetState();
}

class _UserChangeEmailAndPasswordPageWidgetState
    extends State<UserChangeEmailAndPasswordPageWidget> {
  late UserChangeEmailAndPasswordPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserChangeEmailAndPasswordPageModel());
      ...
      body: SafeArea(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(15.0, 24.0, 0.0, 20.0),
                child: Text(
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  textCapitalization: TextCapitalization.words,
                  obscureText: !_model.cityVisibility1,
                  decoration: InputDecoration(
                    labelStyle:
                        FlutterFlowTheme.of(context).labelMedium.override(
                              fontFamily: 'Inter',
                    ...
                    suffixIcon: InkWell(
                      onTap: () => setState(
                        () => _model.cityVisibility1 = !_model.cityVisibility1,
                      ),
                      focusNode: FocusNode(skipTraversal: true),
                      child: Icon(
                        _model.cityVisibility1
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  textCapitalization: TextCapitalization.words,
                  obscureText: !_model.cityVisibility2,
                  decoration: InputDecoration(
                    labelStyle:
                        FlutterFlowTheme.of(context).labelMedium.override(
                              fontFamily: 'Inter',
                    ...
                    suffixIcon: InkWell(
                      onTap: () => setState(
                        () => _model.cityVisibility2 = !_model.cityVisibility2,
                      ),
                      focusNode: FocusNode(skipTraversal: true),
                      child: Icon(
                        _model.cityVisibility2
                            ? Icons.visibility_outlined
                            : Icons.visibility_off_outlined,
                        color: Color(0xFF757575),
                        size: 22.0,
