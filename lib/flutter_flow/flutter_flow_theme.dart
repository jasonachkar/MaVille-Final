...
abstract class FlutterFlowTheme {
  ...
  late Color ashGray;
  late Color cadetGray;
  late Color hookersGreen;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF4CA556);
  ...
  late Color alabaster = Color(0xFFE4E8DA);
  late Color timberwolf = Color(0xFFD2D4C8);
  late Color ashGray = Color(0xFFB8BDB5);
  late Color cadetGray = Color(0xFF889696);
  late Color hookersGreen = Color(0xFF5F7470);
  late Color customColor1 = Color(0xFFFF9A26);
}
